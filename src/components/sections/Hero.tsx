        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 py-20 lg:py-0">
          ...
          >
            ...
            <motion.div
              ...
              className="text-lg sm:text-xl lg:text-2xl text-muted-foreground mb-6 h-16"
            >
              <TypeAnimation
                key={language}
            ...
            <motion.p
              ...
              className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 mb-8 leading-relaxed"
            >
              {description}
            </motion.p>
            ...
            <motion.div
              ...
              className={`flex flex-col sm:flex-row items-center justify-center ${isRTL ? 'lg:justify-start' : 'lg:justify-start'} gap-4 mb-12`}
            >
              <a 
                href="#projects" 
            ...
            <motion.div
              ...
              className={`flex items-center justify-center ${isRTL ? 'lg:justify-start' : 'lg:justify-start'} gap-8 lg:gap-12`}
            >
